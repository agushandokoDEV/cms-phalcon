...
<div class="row">
    <div class="col-md-6">
        ...
        <form class="form-media" action="/media/edit/{{data.row.media_id}}" method="POST" id="form-add" enctype="multipart/form-data">
          <input type="hidden" name="album_id" id="album_id"/>
          <div class="form-group">
            <label for="exampleInputEmail1">Name</label>
            <input type="text" class="form-control" name="media_name" placeholder="Name" value="{{data.row.media_name}}" required>
          </div>
          <div class="form-group">
            <label for="exampleInputEmail1">Caption</label>
            <input type="text" class="form-control" name="caption" placeholder="Caption" value="{{data.row.media_caption}}" required>
          </div>
          <div class="form-group">
            <label for="exampleInputEmail1">Media</label>
            <input type="file" class="form-control" name="file" placeholder="Media">
          </div>
          <div class="form-group">
            {{data.media_uri}}
          </div>
          <button type="submit" id="btn-upload" class="btn btn-success">Submit</button>
...
$(document).ready(function(){
    album.jstree({
        ...
        album.jstree("deselect_all");
        album.jstree('select_node', '{{data.row.album_id}}');
