...
<div class="row">
    <div class="col-md-8">
          ...
          <form action="/advertising/edit/{{data.row.id}}" method="POST" id="form-add">
            <div class="hidden" id="list-media-attch"></div>
            <div class="form-group">
                <label for="exampleInputEmail1">Advertiser :</label>
                <input type="text" class="form-control" name="advertiser" placeholder="Advertiser" value="{{data.row.advertiser}}">
            </div>
            <div class="form-group">
                <label for="exampleInputEmail1">Page location :</label>
                <select name="post_location" id="post_location" class="form-control">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="price" placeholder="Price" value="{{data.row.price}}">
            </div>
            <div class="form-group">
                <label for="exampleInputEmail1">Web URL :</label>
                <input type="text" class="form-control" name="url_web" placeholder="Web URL" value="{{data.row.url_web}}">
            </div>
            <div class="form-group">
                <label for="exampleInputEmail1">Date :</label>
                <div class="row">
                    <div class="col-md-6">
                        <input type="text" class="form-control dp" name="start_date" placeholder="From" value="{{data.row.start_date}}">
                    </div>
                    <div class="col-md-6">
                        <input type="text" class="form-control dp" name="end_date" placeholder="To" value="{{data.row.end_date}}">
                    </div>
                </div>
            </div>
            <div class="form-group">
...
$(document).ready(function(){
    $('#post_location').val('{{data.row.post_location}}');
    $('#contract').val('{{data.row.contract}}');
