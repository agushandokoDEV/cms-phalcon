  ...
  <div class="panel-footer" style="padding: 0;">
    <nav class="text-center nav-pills-blue">
      <ul class="pagination pagination-blue" style="margin: 10px 0;">
        <li>
          <a href="/index/tags/{{content.query_tags}}" aria-label="Previous">
            <span aria-hidden="true"><i class="fa fa-backward"></i></span>
          </a>
        </li>
        <li><a href="/index/tags/{{content.query_tags}}?page={{content.list_posting.before}}">Prev</a></li>
        <li><a href="/index/tags/{{content.query_tags}}?page={{content.list_posting.next}}">Next</a></li>
        <li>
          <a href="/index/tags/{{content.query_tags}}?page={{content.list_posting.last}}" aria-label="Next">
