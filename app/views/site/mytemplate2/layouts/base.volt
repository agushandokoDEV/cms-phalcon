...
<html lang="en">
  <head>
    ...
    <title>{{config.apps.blogname}} - {{title}}</title>
  ...
  <div class="container" style="margin-top: 10px;">
    <!-- Navbar -->
    <div class="navbar navbar-default" role="navigation" style="background: #5bc0de;">
  ...
  <div class="container">
    <div class="row">
        ...
        <div class="col-md-3">
            ...
            <h3 style="margin-top: 20px;border-bottom: 4px double #ddd;padding-bottom: 5px;color: whitesmoke;font-weight: bold; text-shadow: 1px 1px 5px black;font-family: tes-font;">Top list 5 konten</h3>
            <div class="myWrapper">
                    ...
                    <li style="border-bottom: 1px solid #ddd;padding: 10px 0 10px 0;">
                        <div class="media">
                          ...
                          <div class="media-body">
                            <h5 class="media-heading"><a style="text-decoration: none;" href="/index/detail/{{top_content.post_slug}}">{{top_content.post_title}}</a></h5>
