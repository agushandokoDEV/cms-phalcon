...
class Multimenu extends Component{
	 ...
	 * @var string
	 */
	private $menu_key                 = 'resources_name';
	 ...
	 * @var string
	 */
	private $menu_parent              = 'menu_parent_id';	
	...
	{
		$segment = $this->segment($this->uri_segment);
